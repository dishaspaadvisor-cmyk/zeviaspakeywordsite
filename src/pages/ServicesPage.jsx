  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Visit Zevia Spa near Jetalpur Road, Vadodara for full body massage, Thai massage, deep tissue massage, Swedish massage, hot oil massage, four hand massage, couple spa and premium wellness therapies."
        />
      ...
      <PageHero
        title="Our Services"
        description="Discover premium massage therapies and wellness treatments created for relaxation, comfort and rejuvenation."
      />
