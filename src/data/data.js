  ...
  hero: {
    ...
    slides: [
...

      {
        ...
        highlight: "New Staff Available",
        description:
          "Escape from everyday stress and enjoy a deeply relaxing wellness experience designed for complete rejuvenation.",
      },
...
export const aboutData = {
  ...
  highlights: [
    {
      ...
      description:
        "Relaxing spa treatments designed to give you comfort, calmness and complete wellness.",
    },

    {
      ...
      description:
        "A peaceful and comfortable environment created to help you relax from the moment you arrive.",
    },

    {
      ...
      description:
        "Quality spa service with attention to comfort, cleanliness and a relaxing guest experience.",
    },
  ],
  ...
  quote: "Relax. Refresh. Rejuvenate.",
};
// src/data/data.js
...
export const offersData = [
...

  {
    ...
    title: "All Services Offer",

    offerText: "Special Price On Services",
...

  {
    ...
    offerText: "Exclusive Member Benefits",
